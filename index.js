...
app.post('/user',(req,res)=>{
    res.render("user",{user:{last_name:req.body.last_name,first_name:req.body.first_name}})
})
app.route('/answer')
    .get((req,res)=>{
    ...
    .post((req,res)=>{
        res.render("answer",{user:{last_name:req.body.last_name,first_name:req.body.first_name,team:req.body.team}})
    });
